                ...
                <div class="card-body p-2">
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 col-12">
                            ...
                            <textarea class="form-control form-control-sm" name="postagem_informacoes" placeholder="Informações" rows="4"><?php echo $buscaPostagem['dados']['postagem_informacoes'] ?></textarea>
                        </div>
                        <div class="col-md-3 col-12">
