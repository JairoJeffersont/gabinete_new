...
$busca = $emendaStatusController->listarEmendaStatus($_SESSION['usuario_gabinete']);
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                <div class="card-header bg-primary text-white px-2 py-1 card_descricao_bg"><i class="bi bi-building"></i> Adicionar Status de Emenda</div>
            ...
            <div class="card shadow-sm mb-2">
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = $emendaStatusController->novoEmendaStatus($dados);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        ...
                        <div class="col-md-4 col-12">
                            <input type="text" class="form-control form-control-sm" name="emendas_status_descricao" placeholder="Descrição" required>
                        </div>
                        ...
                        <table class="table table-hover table-bordered table-striped mb-0 custom-table">
                            ...
                            <tbody>
                                ...
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $emendaStatus) {
                                        echo '<tr>';
                                        echo '<td style="white-space: nowrap;"><a href="?secao=emenda-status&id=' . $emendaStatus['emendas_status_id'] . '">' . $emendaStatus['emendas_status_nome'] . '</a></td>';
                                        echo '<td style="white-space: nowrap;">' . $emendaStatus['emendas_status_descricao'] . '</td>';
                                        echo '</tr>';
                                    }
