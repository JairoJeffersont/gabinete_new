                        ...
                        <form class="row g-2 form_custom" method="POST">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                if ($buscaNota['status'] == 'success') {
                                    ...
                                    echo '<a href="?secao=imprimir-proposicaoCD&id=' . $proposicaoIdGet . '" id="btn_imprimir" target="_blank" type="button" class="btn btn-secondary btn-sm"><i class="bi bi-printer"></i> Imprimir</a>';
                                } else {
                                    echo '<button type="submit" class="btn btn-success btn-sm" name="btn_salvar"><i class="bi bi-floppy-fill"></i> Salvar</button>&nbsp;';
                                    echo '<a href="?secao=imprimir-proposicaoCD&id=' . $proposicaoIdGet . '" target="_blank" id="btn_imprimir" type="button" class="btn btn-secondary btn-sm"><i class="bi bi-printer"></i> Imprimir</a>';
                                }
