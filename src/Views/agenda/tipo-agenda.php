...
$busca = $agendaController->buscaAgendaTipo($id);

if ($busca['status'] != 'success') {
    header('Location: ?secao=tipos-agenda');
}
        ...
        <div class="container-fluid p-2">
            <div class="card mb-2">
                <div class="card-body p-1">
                    ...
                    <a class="btn btn-success btn-sm custom-nav barra_navegacao" href="?secao=tipos-agenda" role="button"><i class="bi bi-arrow-left"></i> Voltar</a>
                </div>
            </div>
            <div class="card mb-2">
            ...
            <div class="card shadow-sm mb-2">
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_atualizar'])) {
                        ...
                        $dados = [
                            'agenda_tipo_id' => htmlspecialchars($id, ENT_QUOTES, 'UTF-8'),
                        ...
                        $result = $agendaController->atualizarAgendaTipo($dados);
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_apagar'])) {
                        ...
                        $result = $agendaController->apagarAgendaTipo($id);
                        if ($result['status'] == 'success') {
                            header('Location: ?secao=tipos-agenda');
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="agenda_tipo_nome" placeholder="Nome do Tipo" value="<?php echo $busca['dados']['agenda_tipo_nome'] ?>" required>
                        </div>
                        <div class="col-md-4 col-12">
                            <input type="text" class="form-control form-control-sm" name="agenda_tipo_descricao" placeholder="Descrição" value="<?php echo $busca['dados']['agenda_tipo_descricao'] ?>" required>
                        </div>
