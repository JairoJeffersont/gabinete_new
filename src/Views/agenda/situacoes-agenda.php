...
$busca = $agendaController->listarAgendaSituacoes($_SESSION['usuario_gabinete']);
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                <div class="card-header bg-primary text-white px-2 py-1 card_descricao_bg"><i class="bi bi-flag"></i> Adicionar Situação da Agenda</div>
                <div class="card-body card_descricao_body p-2">
                    <p class="card-text mb-2">Nesta seção, é possível adicionar e editar as situações da agenda para um melhor controle.</p>
                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        $dados = [
                            ...
                            'agenda_situacao_gabinete' => $_SESSION['usuario_gabinete']
                        ];

                        $result = $agendaController->novaAgendaSituacao($dados);
                            ...
                            <tbody>
                                ...
                                if ($busca['status'] == 'success') {
                                    foreach ($busca['dados'] as $situacao) {
                                        echo '<tr>';
                                        echo '<td style="white-space: nowrap;"><a href="?secao=situacao-agenda&id=' . $situacao['agenda_situacao_id'] . '">' . $situacao['agenda_situacao_nome'] . '</a></td>';
                                        echo '<td style="white-space: nowrap;">' . $situacao['agenda_situacao_descricao'] . '</td>';
                                        echo '</tr>';
                                    }
