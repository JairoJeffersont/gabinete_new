                ...
                <div class="card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        $dados = [
                            ...
                            'pessoa_tipo_criador_por' => $_SESSION['usuario_id'],
                            'pessoa_tipo_gabinete' => $_SESSION['usuario_gabinete'],
                            'pessoa_tipo_criado_por' => $_SESSION['usuario_id'],
                            'pessoa_tipo_id' => $id
                        ];

                        $result = $pessoaController->atualizarTipoPessoa($dados);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="pessoa_tipo_nome" placeholder="Nome do Tipo" value="<?php echo $busca['dados']['pessoa_tipo_nome'] ?>" required>
                        </div>
